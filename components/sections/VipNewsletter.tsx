...
export default function VipNewsletter() {
  return (
    <section className="py-24 px-6 bg-[#0c0d0c] border-t border-brand-gold/10 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 glass p-10 md:p-16 rounded-sm md:rounded-3xl border border-brand-gold/20 shadow-2xl">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-5xl text-white mb-6">Patronların Arasına Katıl</h2>
          <p className="font-sans text-gray-400 text-sm md:text-base mb-10 max-w-xl mx-auto font-light leading-relaxed">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              required
              className="flex-1 bg-brand-obsidian/60 border border-brand-gold/30 px-6 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-brand-gold transition-colors text-sm tracking-widest text-center sm:text-left"
            />
            <motion.button 
