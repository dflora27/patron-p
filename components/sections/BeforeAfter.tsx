...
export default function BeforeAfter() {
  ...
  return (
    <section className="py-24 md:py-32 px-6 bg-surface relative border-t border-brand-gold/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
        <div className="lg:w-1/3">
          ...
          <motion.p
            ...
            className="font-sans text-foreground-muted text-sm leading-relaxed mb-8"
          >
            {isEn ? (
        ...
        >
          ...
          >
            <div className="relative w-full h-full rounded-xl overflow-hidden">
              <Image
                src="/images/sonra.jpg"
                alt={isEn ? "After — Patron cut" : "Sonra — Patron kesimi"}
                fill
              ...
              >
                <Image
                  src="/images/once.jpg"
                  alt={isEn ? "Before — original" : "Önce — orijinal"}
                  fill
                  sizes="(max-width: 1024px) 100vw, 66vw"
