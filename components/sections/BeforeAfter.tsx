...
export default function BeforeAfter() {
  ...
  return (
    <section className="py-32 px-6 bg-brand-obsidian relative border-t border-brand-gold/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
        <div className="lg:w-1/3">
          ...
          <motion.p
            ...
            className="font-sans text-gray-400 text-sm leading-relaxed mb-8"
          >
            {isEn ? (
        ...
        >
          ...
          >
            <div className="relative w-full h-full rounded-xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-brand-black/20 pointer-events-none"></div>
              ...
              >
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-brand-obsidian border-[2px] border-brand-gold flex items-center justify-center shadow-2xl">
