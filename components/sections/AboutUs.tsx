...
export default function AboutUs() {
  ...
  return (
    <section id="about" className="py-32 px-6 bg-[#0c0d0c] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-16 md:gap-24 relative z-10">
        ...
        >
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full md:w-[80%] md:h-[80%] opacity-[0.03] z-0 pointer-events-none flex items-center justify-center">
            <img src="/images/emblem.png" alt="Emblem Fill" className="w-[80%] object-contain filter grayscale" />
          </div>
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-white leading-tight mb-8 relative z-10">
          ...
          <div className="font-sans text-gray-300 space-y-6 text-sm md:text-base leading-relaxed font-light relative z-10">
            <p>
              {isEn
        ...
        <motion.div
          ...
          className="md:w-1/2 relative w-full flex justify-center hidden md:flex"
        >
          {/* Glass Masked Arch Profile */}
          <div className="w-full max-w-sm aspect-[3/4] rounded-[100px] border border-brand-gold/10 overflow-hidden relative shadow-2xl p-2 glass">
            <div className="w-full h-full rounded-[90px] overflow-hidden">
              <img
                ...
                alt=""
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-[2s] sepia-[.2] contrast-125 brightness-75"
              />
            </div>
          </div>
          ...
          <motion.div
            ...
            className="absolute -bottom-8 -left-8 glass px-6 py-4 rounded-xl flex items-center gap-4 border"
          >
            <div className="w-3 h-3 bg-brand-gold rounded-full animate-pulse"></div>
            <div className="text-left">
              <div className="text-white font-serif text-xl border-b border-brand-gold/20 leading-tight">Ferdi <br />Bakır</div>
            </div>
          </motion.div>
        </motion.div>
