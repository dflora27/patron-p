...
export default function JournalSection() {
  ...
  return (
    <section className="py-32 px-6 bg-surface relative border-t border-brand-gold/10">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 relative z-10">
        <div className="md:w-1/3 flex flex-col justify-center">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="font-serif text-4xl md:text-5xl text-foreground mb-6">
            {isEn ? "The Art of Gentlemen" : "Erkek Olma Sanatı"}
          </motion.h2>
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="text-foreground-subtle text-sm leading-relaxed mb-10">
