...
export default function ParallaxHero() {
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-brand-black">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 flex flex-col items-center md:items-start text-center md:text-left pt-20">
        ...
        >
          ...
          <motion.p
            ...
            className="font-sans text-gray-400 text-sm md:text-base max-w-xl font-light leading-relaxed"
          >
          ...
          >
            ...
            <a
              ...
              className="w-full sm:w-auto text-center bg-white/5 border border-white/20 text-white px-10 py-5 uppercase text-[10px] tracking-widest hover:border-brand-gold hover:text-brand-gold transition-all"
            >
      ...
      >
        <span className="text-[9px] uppercase tracking-[0.3em] text-gray-500 font-bold">{isEn ? "Scroll" : "Keşfet"}</span>
