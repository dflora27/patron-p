...
export default function JournalArchiveEn() {
    ...
    <main className="min-h-screen bg-surface pt-40 pb-24 px-6 md:px-12 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        ...
        <div className="flex flex-col mb-20 md:w-2/3">
          <motion.h4 className="text-brand-gold tracking-[0.2em] text-xs font-bold uppercase mb-4">
            The Journal
          </motion.h4>
          <motion.h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-foreground mb-8">
            {isEn ? "Editorial & Stories" : "Yazılar ve Hikayeler"}
          </motion.h1>
          <motion.p className="text-foreground-muted text-base md:text-lg leading-relaxed max-w-xl">
            {isEn
