...
export const WA_MESSAGES = {
  ...
  customMultiTr: (services: string, price: string, day: string, time: string) =>
    `Merhaba Patron, şu hizmetler için randevu almak istiyorum: ${services}. Toplam ${price}. Gün: ${day}, saat aralığı: ${time}. Müsaitliğinizi paylaşabilir misiniz?`,
  customMultiEn: (services: string, price: string, day: string, time: string) =>
    `Hello Patron, I'd like to book: ${services}. Total ${price}. Day: ${day}, time window: ${time}. Could you share your availability?`,
} as const;
